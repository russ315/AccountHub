...
public interface IGameAccountService
{
    ...
    Task<GameAccountEntity> UpdateGameAccount(UpdateGameAccountDto dto, CancellationToken cancellationToken);
    Task DeleteGameAccountById(long id,CancellationToken cancellationToken);
}